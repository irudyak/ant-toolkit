		...
		<html>
			...
			<body class="pageBody">
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="largeFont">
							<b>Summary</b><xsl:text> : </xsl:text><xsl:value-of select="/report/summary/changes/@count"/><span class="defaultFont"> changes</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<table class="defaultFont" cellpadding="0" cellspacing="0" width="50%" border="0">
								<xsl:for-each select="/report/summary/changes/author">
									<tr>
										<td nowrap="nowrap">
										...
										<td class="smallFont" valign="middle">
											<xsl:value-of select="@count"/>&#160;changes&#160;	
										</td>
										<td width="100%" valign="middle">
											<table cellpadding="0" cellspacing="0" width="{@percent}%" border="0">
												<tr>
													<td width="100%" height="100%" class="graphColor">
														<span class="separatorFont">&#160;</span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td colspan="4" class="separatorFont">&#160;</td>
									</tr>
								</xsl:for-each>
							</table>
						</td>
							...
							<table class="defaultFont" cellpadding="0" cellspacing="0" width="100%" align="left" border="0">
								<xsl:for-each select="/report/author">
									<tr class="authorBackground">
										<td colspan="4"><b><xsl:value-of select="@name"/></b><xsl:text> : </xsl:text><span class="smallFont"><xsl:value-of select="@changes"/> changes</span></td>
									</tr>
