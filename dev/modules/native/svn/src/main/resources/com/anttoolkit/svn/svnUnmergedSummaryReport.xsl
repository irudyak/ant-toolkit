		...
		<html>
			...
			<body class="pageBody">
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td class="largeFont">
							<b>Summary</b><xsl:text> : </xsl:text><xsl:value-of select="/report/summary/changes/@count"/><span class="defaultFont"> unmerged changes</span>
						</td>
					</tr>
					<tr>
							...
							<table class="defaultFont" cellpadding="0" cellspacing="0" width="50%" border="0">
								<xsl:for-each select="/report/summary/changes/author">
									<tr>
										...
										<td class="smallFont" valign="middle" nowrap="true">
											<xsl:value-of select="@count"/>&#160;unmerged changes&#160;
										</td>
