...
public class ProtectObjectTask
		extends GenericIRMTask
{
			...
			throws BuildException
	{
		...
		try
		{
			((IDfAspects)obj).detachAspect("irm_document_aspect", null);
		}
		catch (DfException e)
		{
			throw new BuildException("Failed to detach IRM profile from document r_object_id=" + objectId, e);
		}
