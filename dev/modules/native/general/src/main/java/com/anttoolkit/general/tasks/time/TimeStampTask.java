		...
		extends GenericTask
{
	...
	public void doWork() throws BuildException
	{
		try
		{
			...
			if (property != null)
			{
				setPropertyThreadSafe(property, Long.toString(d.getTime()));
			}

			for (CustomFormat cts : customFormats)
			{
				cts.execute(d, getLocation());
			}
		}
		catch (Exception e)
		{
			throw new BuildException("Failed to get current timestamp", e);
		}
	}
	...
	public class CustomFormat
	{
		 ...
		 */
		public void execute(Date date, Location location)
		{
			...
			TimeStampTask.this.setPropertyThreadSafe(propertyName, sdf.format(date));
		}
	}
