...
public class SingleColumnValueExcludeFilterConfig extends ComparatorFilterConfig
{
	...
	{
		validate(task);
		return new SingleColumnValueExcludeFilter(Bytes.toBytes(family), Bytes.toBytes(column),
